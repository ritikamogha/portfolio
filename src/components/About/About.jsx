...
import profileImage from "../../assets/photo/photo.jpg";
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            I am a front-End developer passionate in building scalable web
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1Xvzzqegcnp3IqJbWqu9Hq5hFH4jO_Nkh/view?usp=drivesdk"
            target="_blank"
